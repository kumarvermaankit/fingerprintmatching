...
sample = cv2.imread('3__M_Left_little_finger_sample.BMP')
...
counter =0
for file in [file for file in os.listdir("/home/sourav/projects/python/fingerprint/archive/SOCOFing/Real")][:1000]:
    if counter%10 ==0:
        print(counter)
        print(file)
    counter+=1
    fingerprint_image = cv2.imread('/home/sourav/projects/python/fingerprint/archive/SOCOFing/Real/' + file)
